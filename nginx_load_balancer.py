...
if __name__ == "__main__":
    ...
    parser.add_argument('--fa_addr', type=str, help='fastapi server address')
    parser.add_argument('--fa_ports', type=str, help='comma separated fastapi server ports')
    ...
    print(f'''
    !!!! PLEASE EXECUTE THE COMMANDS BELOW TO SETUP FASTAPI LOADBALANCER !!!!
    ```
